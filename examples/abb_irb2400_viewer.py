...
# with open(r"C:\Users\wasonj\Documents\RobotRaconteur2\tesseract_python\tesseract_viewer_python\tesseract_viewer\resources\static\tesseract_scene.babylon", "w") as f:
#     f.write(babylon_text)

# a=dict()
# a["joints"]=["joint_1, joint_2, joint_3, joint_4, joint_5, joint_6"]
